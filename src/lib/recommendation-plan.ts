...
export const CHECKLIST_PRIORITARIO = [
  { id: "chk-1", texto: "Completar perfil de recuperación", href: "/dashboard/profile" },
  { id: "chk-2", texto: "Registrar contacto de emergencia", href: "/dashboard/profile" },
  { id: "chk-3", texto: "Reunir documentos médicos", href: "/dashboard/resources" },
  { id: "chk-4", texto: "Actualizar seguimiento esta semana", href: "/dashboard/followup" },
  { id: "chk-5", texto: "Verificar trámites laborales (si aplica)", href: "/dashboard/resources" },
];
