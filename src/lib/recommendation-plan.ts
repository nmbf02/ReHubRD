...
export const CHECKLIST_PRIORITARIO = [
  { id: "chk-1", texto: "Completar perfil de recuperación", href: ROUTES.profile },
  { id: "chk-2", texto: "Registrar contacto de emergencia", href: ROUTES.profile },
  { id: "chk-3", texto: "Reunir documentos médicos", href: ROUTES.resources },
  { id: "chk-4", texto: "Actualizar seguimiento esta semana", href: ROUTES.followup },
  { id: "chk-5", texto: "Verificar trámites laborales (si aplica)", href: ROUTES.resources },
];
